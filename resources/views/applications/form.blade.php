...
<div data-tab-group>
  <div class="flex flex-wrap items-center gap-1 border-b border-line mb-5">
    <button type="button" data-tab-target="lamaran" class="px-4 py-2 text-sm border-b-2 -mb-px border-transparent text-muted hover:text-slate-900">Application</button>
    <button type="button" data-tab-target="progres-tahapan" class="px-4 py-2 text-sm border-b-2 -mb-px border-transparent text-muted hover:text-slate-900">Stage Progress</button>
  </div>
...
<div class="bg-panel border border-line rounded-xl p-6 shadow-sm">
  <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
    ...
    <div class="md:col-span-3 min-w-0">
      <label class="{{ $label }}">Interview Score (1-10)</label>
    ...
    <div class="md:col-span-3 min-w-0">
      <label class="{{ $label }}">MCU Result</label>
    ...
    <div class="md:col-span-3 min-w-0">
      <label class="{{ $label }}">Offer Date</label>
      <input type="date" name="offer_date" value="{{ $val('offer_date') }}" class="{{ $input }}">
    </div>
    <div class="md:col-span-3 min-w-0">
      <label class="{{ $label }}">Offered Salary</label>
